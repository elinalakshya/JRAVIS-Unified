...
def send_report():
    ...
    subject = f"JRAVIS Daily Report – {datetime.now():%d-%m-%Y}"
    body = ("Hello Boss 👋\n\n"
            "✅ JRAVIS Daily Report executed successfully.\n\n"
    ...
    # Simpler: use send_direct wrapper that accepts EmailMessage bytes — but to avoid changing smtp_direct_sender,
